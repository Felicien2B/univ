...
def test_moyenne():
    ...
    lst=[-5,-2,1,4]
    print("Test moyenne 3.5 :", moyenne(lst))
...
def test_position_tri():
    ...
    #test liste vide
    print("Test liste vide :", position_tri([],0))
    #test valeur introuvable
    lst=[4,3,8,-1,0]
    e = 5
    print("Test valeur introuvable :", position_tri(lst,e))
    #test valeur dans la liste
    lst=[4,3,8,-1,0]
    e = 3
    print("Test valeur dans la liste :", position_tri(lst,e))

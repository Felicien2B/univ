...
public class Secretaire extends Employe {
     ...
     * Renvoie le nombre de managers gérés par un secrétaire
     ...
     * Augmente le salaire d'un secrétaire suivant un pourcentage donné, avec un bonus pour chaque manager géré
    ...
    /**Méthode ajoutManager
     * Ajoute un manager à la liste des managers gérés par un secrétaire
     * @param ma Manager à ajouter
	 */
